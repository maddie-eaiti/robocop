...
def generate(highlight: str, context: str, request: str) -> str:
  ...
  msg1_text1 = types.Part.from_text(text=f"""You are a helpful assistant. You are given a highlight context and a request. {highlight_block}. The previous work they have done is: \"{context}\". The user has asked you to: \"{request}\". 
